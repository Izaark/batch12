...
class DireccionListView(ListView):
    model = Direccion
    template_name = "direccion/direccion_list.html"
    paginate_by = 2

class DireccionCreateView(CreateView):
	model = Direccion
	form_class = DireccionForm
	template_name = 'direccion/direccion_forms.html'
	success_url = reverse_lazy('direccion:direccion/direccion_listar')
...
class DireccionDeleteView(DeleteView):
	model = Direccion
	template_name = 'direccion/direccion_delete.html'
	success_url = reverse_lazy('direccion:direccion/direccion_listar')